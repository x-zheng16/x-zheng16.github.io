...
| Date | Venue | Title |
| :--- | :--- | :--- |
| Aug 30 | **Xi'an**, CCF YOCSEF | Towards Robust Embodied AI: Skill Discovery and Red Teaming |
| May 28 | **Shenzhen**, Southern University of Science and Technology | Reinforcement Learning-Based Adversarial Safety Evaluation and Defense Enhancement for Large Language Models |
| Apr 27 | **Xi'an**, CCF YOCSEF | Reinforcement Fine-Tuning for Large Model Red-/Blue-Teaming |
